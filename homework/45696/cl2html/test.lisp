...
(defun <{}-[[[-_-]]]-{}> ()
  (write "This is really a valid function name."))

(defun Hello\ World! (name)
  (write (format nil
                 "~D has commited an atrocity by using this function."
                 name)))


(defun defun ()
  "Don't!
Usually there is a package lock that prevents you from doing this
but most compilers will let you unlock it.
As you might imagine this will lead to hell."
  (write-line "Nope."))
